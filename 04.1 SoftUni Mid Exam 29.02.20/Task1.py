...
# to ask and the employees have to help everyone by providing correct information and to answer all questions.
...
while total_people > 0:
    time_needed += 1
    if not time_needed % 4 == 0:
        total_people -= (e1_eff + e2_eff + e3_eff)
